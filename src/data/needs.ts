...
export const categories: Category[] = [
  ...
  },
  {
    ...
    words: [
      ...
      { word: 'security', definition: 'Trusting that what you depend on will still be there tomorrow.' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: 'consciousness', definition: 'Living on purpose rather than on autopilot.' },
      ...
      { word: 'discovery', definition: 'The small shock of finding what was there all along.' },
      ...
      { word: 'learning', definition: 'Adding to what you can do or understand.' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: 'sexual expression', definition: 'Desire that gets to be spoken and acted on.' },
